...
import com.server.campushelpserver.entity.dto.QuestionAuditDTO;
...
public class AdminQuestionController {
    ...
    public Result<java.util.List<StudyAnswer>> getAnswersByQuestionId(
            @Parameter(description = "问题ID") @PathVariable Long questionId) {
        java.util.List<StudyAnswer> answers = questionService.getAnswersByQuestionId(questionId);
