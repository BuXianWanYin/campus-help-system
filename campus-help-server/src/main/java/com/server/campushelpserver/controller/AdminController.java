...
import com.server.campushelpserver.entity.dto.DailyTrendDTO;
import com.server.campushelpserver.entity.dto.DashboardStatsDTO;
...
import com.server.campushelpserver.entity.dto.LostFoundSearchDTO;
...
import com.server.campushelpserver.service.LostFoundService;
...
public class AdminController {
    ...
    public Result<Page<Goods>> getPendingGoodsList(
            @Parameter(description = "分页参数") Page<Goods> page,
            @Parameter(description = "搜索条件") GoodsSearchDTO searchDTO) {
        searchDTO.setPageNum((int) page.getCurrent());
        searchDTO.setPageSize((int) page.getSize());
        Page<Goods> result = goodsService.getPendingAuditList(searchDTO);
        return Result.success("查询成功", result);
    }
